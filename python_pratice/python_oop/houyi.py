...
class HouYi(Game):
    ...
    def __init__(self, my_hp, my_power, enemy_hp, enemy_power,enemy_defense):
        self.defense = 100
        # 继承父类的构造方法
        super().__init__(my_hp, my_power, enemy_hp, enemy_power,enemy_defense)
    ...
    def fight(self):
        ...
        while True:
            ...
            # 敌人的剩余血量
            self.enemy_hp -= self.my_power+self.enemy_defense
...
if __name__ == '__main__':
    houyi = HouYi(1000,150,1100,170,60)
    # 子类对象可以直接调用父类的属性和方法
